...
class FontManager {
 public:
   ...
   * @param index Font index, -1 means disable (fallback to built-in UI font)
   */
   ...
   * @return -1 means using built-in UI font
   */
 ...
 private:
  ...
  int _selectedUiIndex = -1;  // -1 = fallback to built-in UI font
